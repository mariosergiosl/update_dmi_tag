...
#                        momento de confirmar um reboot fisico real,
#                        podia causar confusao sobre qual
...
def main():
    ...
    # esta flag pode causar reboot fisico de equipamentos reais.
    ...
    if getattr(args, "allow_efi_fallback", False):
        ...
        if not (sys.stdin.isatty() and sys.stdout.isatty()):
            sys.stderr.write(
                ...
                "reiniciar equipamentos reais) e nao ha terminal disponivel "
