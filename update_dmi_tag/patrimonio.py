...
# FILE: patrimonio.py
#
# DESCRIPTION: Validacao do numero patrimonial por
...
#                        patrimonial representa DV=10 como "X" (confirmado contra
...
#                        14 digitos (DV=10 no padrao patrimonial).
...
def calcula_dv_modulo11(base_num):
    ...
    DESCRIPTION: Calcula o digito verificador (DV) do numero patrimonial
...
def valida_via_patrimonial_cli(base_num, caminho_log, verbose, suprime_tela,
    ...
    try:
        ...
        if resultado.returncode == 0:
            ...
            # padrao patrimonial), que o filtro antigo por isdigit descartava.
...
def valida_e_calcula_tag(valor_config, caminho_log, verbose, suprime_tela,
    ...
    # padrao patrimonial). Valores de 13 chars devem ser todos numericos.
    ...
    if len(valor_config) == 14:
        ...
        if dv_lido != dv_calculado:
            _log("WARNING",
                 ...
                 "(aceito conforme padrao patrimonial).".format(
